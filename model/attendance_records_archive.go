...
// AttendanceRecordsArchive table structure
type AttendanceRecordsArchive struct {
	bun.BaseModel `bun:"table:attendance_records_archive,alias:ara"`
...
func (ara *AttendanceRecordsArchive) TableName() string {
	return "attendance_records_archive"
}
